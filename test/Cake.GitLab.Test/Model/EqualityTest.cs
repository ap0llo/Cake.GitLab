// Derived from https://github.com/ap0llo/changelog/blob/97d0d3111510dae9f4222704a50d88938be8debe/src/ChangeLog.Test/EqualityTest.cs
    ...
    where TDataProvider : IEqualityTestDataProvider<TTestee>, new()
{
    ...
    private static bool TesteeImplementsEqualityOperators =>
    ...
    public void Comparision_of_two_equal_instances_yield_expected_result(TTestee left, TTestee right)
    {
        ...
        if (TesteeImplementsEqualityOperators)
        {
